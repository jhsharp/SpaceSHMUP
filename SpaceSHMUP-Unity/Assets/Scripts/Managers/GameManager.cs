...
public class GameManager : MonoBehaviour
{
    ...
    public float gameRestartDelay = 2f; // delay before restart
    ...
    [Space(10)]
    public AudioClip bgMusic; // sound clip for background music
    ...
    void Start()
    {
        // play background music (if background music has been set)
        if (bgMusic != null)
        {
    ...
    public void LostLife()
    {
        ...
        else
        {
            ...
            if (resetLostLevel){  
                ...
                Invoke("StartGame", gameRestartDelay); //restart the level after delay
